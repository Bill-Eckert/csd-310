...
def show_account_menu():
    """ displaying the users account menu """
...
def show_wishlist(_cursor, _user_id):
    """ querying the database for a list of books added to the wishlist """
...
def show_books_to_add(_cursor, _user_id):
    """ querying the database for a list of books not in the wishlist """
...
try:
    """ try/catch block for handling potential database errors """ 
